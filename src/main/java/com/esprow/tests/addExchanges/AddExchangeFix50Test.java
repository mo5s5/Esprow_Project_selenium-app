...
public class AddExchangeFix50Test {
    WebDriver driver;
    String url = "https://";
...
//        assertEquals(exchangePageExceptedUrl,driver.getCurrentUrl());
        ...
        // Adding Exchange
        objSubscriptionPage.addExchangeFix_50();
        // Validate if correct exchange is added
        assertEquals("FIX 5.0", driver.findElement(By.cssSelector(".sc-AykKC:nth-child(1) > p")).getText());
